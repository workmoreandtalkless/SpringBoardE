...
function showFirstAndLast(arr){
    ...
    for(let i = 0;i<arr.length;i++){
            showFirstAndLast.push(arr[i][0]+arr[i][arr[i].length-1]);
    }
...
function valTimesIndex(arr){
    return arr.map(function(index,val){
 ...
 * reveiw this method
 * @param {an array} arr 
 * @param {some value to search} searchValue 
 */
